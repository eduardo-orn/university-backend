...
namespace University.Controllers
{
    ...
    public class CoursesController : ApiController
    {
        ...
        /// </summary>
        /// <remarks>
        /// Aqui una descripcion mas larga si es requerida. Obtiene un objeto por su id
        /// </remarks>
        /// <param name="id">Este es el id del objeto</param>
        /// <returns>Objeto Course</returns>
        /// <response code="200">OK, devuelve el objeto solicitado</response>
        /// <response code="404">Not Found, No se a encontrado el objeto solicitado</response>
        ...
        public async Task<IHttpActionResult> Delete(int id)
        {
            ...
            try
            {
                if (!await courseService.DeleteChecOnEntity(id))
